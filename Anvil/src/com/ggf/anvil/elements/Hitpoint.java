...
public class Hitpoint extends Actor
{
  ...
  public Hitpoint()
  {
    ...
    for (int i = 1; i <= HITPOINTS; i++)
      hitpoint[i - 1] = new Texture(Gdx.files.internal("data/hitpoint" + i + ".png"));
  ...
  public void draw(SpriteBatch batch, float parentAlpha)
  {
    ...
    batch.draw(hitpoint[Math.min(HITPOINTS - 1, (int) Math.floor((float) (0.5f * (Math.sin(time) + 1.0f)) * (HITPOINTS)))], getX(), getY());
  ...
  public void hit()
  {
    ...
    Hitpoint.this.setColor(1, 1, 1, Hitpoint.this.health / (float) Hitpoint.this.maxHealth);
    if (generalQuality > 0.5f)
    {
      Bubble b = new Bubble(new Texture(Gdx.files.internal("data/bubble" + ((new Random()).nextInt(3) + 1) + ".png")));
    ...
    case 0:
      ...
      break;
    case 1:
      SoundManager.play(AnvilSound.DENGEL2);
      break;
    case 2:
      SoundManager.play(AnvilSound.DENGEL3);
      break;
    case 3:
      SoundManager.play(AnvilSound.DENGEL4);
      break;
    }

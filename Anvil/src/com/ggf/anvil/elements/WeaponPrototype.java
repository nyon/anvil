...
public class WeaponPrototype extends Group
{
  ...
  public WeaponPrototype(Item grip, Item crossguard, Item blade)
  {
    ...
    TextureData td;
    td = grip.textureMap.get(State.ON_ANVIL).getTextureData();
    td.prepare();
    Pixmap gripPix = td.consumePixmap();

    td = crossguard.textureMap.get(State.ON_ANVIL).getTextureData();
    td.prepare();
    Pixmap crossguardPix = td.consumePixmap();

    td = blade.textureMap.get(State.ON_ANVIL).getTextureData();
    td.prepare();

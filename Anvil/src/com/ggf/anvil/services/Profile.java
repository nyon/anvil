...
public class Profile implements Serializable
{
  ...
  public void read(Json json, JsonValue jsonData)
  {
    ...
    // player.achievements =
    // (java.util.List<String>)json.readValue("achievements",
    // java.util.List.class, String.class, jsonData);
    // FIXME : see below :)
    // player.inventory = (java.util.List<Item>)json.readValue("inventory",
    // java.util.List.class, Item.class, jsonData);
    reset();
  }
